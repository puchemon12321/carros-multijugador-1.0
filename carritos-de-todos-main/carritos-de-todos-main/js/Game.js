class Game {
  ...
  start() {
    ...
    var obstacle2Positions=[
      ...
      {x:width/2-150,y:height-2300,image:obstacle2Image},
  ...
  addSprites(spriteGroup, numero, image, scale,positions=[]){
...
showFuelBar(){
  ...
  fill("white");
  rect(width/2-100,height-player.positionX-100,185,20);
  fill("yellow");
